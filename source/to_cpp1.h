    ...
    //  Function
      ...
      //  Else start introducing a normal function
        ...
        if (n.is_constructor() || n.is_assignment()) {
          ...
          //  If this operator= has two parameters, it's setting from a single
          //  value -- either from the same type (aka copy/move) or another type
          //  (a conversion) -- so recurse to emit related functions if the user
          //  didn't write them by hand
          if (func->parameters->ssize() == 2 &&
            ...
            if (
                ...
                //      and the user didn't write any other ctor/assignment
                //      function themselves
                ...
                //  and the user didn't write an assignment from this type
                //  themselves and the type is not polymorphic (this generation
                //  is great for most types, but polymorphic base classes often
                //  have no meaningful way to write assignment)
                (!n.parent_is_polymorphic() && n.is_constructor() &&
